...
class ContentListItem extends React.Component {
    ...
    //大区选择
    render() {
        // console.log("渲染的data",this.props.data.id)
        return (
            <div className="itemcol" style={{
                width: (100 / this.props.len) + "%"
            }}>
      <div className={this.props.titletag ? "showblock itemcoltitle" : "showline"} key={this.props.data.title} onClick={this.props.optionClick.bind(this,"详情",this.props.data.id)}>{this.props.data.title}</div>
